...
2. Click **New project**.
3. Choose a name (e.g. `casa-rustia-budget`), set a strong database password, pick a region close to you.
...
```bash
# Initialise a git repo inside the casa-rustia-budget folder
cd casa-rustia-budget
git init
git add .
git commit -m "Initial commit — Casa Rustia Budget OS"

# Create a repo on GitHub (e.g. casa-rustia-budget), then:
...
5. After ~1 minute, your app is live at:
   `https://YOUR_USERNAME.github.io/casa-rustia-budget/`
